// this file was generated by ./codegen/tbgen on 2021-04-02 13:34:02 -0400
// do NOT edit it by hand
module regfile_tb();
reg clk, reset;
reg [31:0] current_vec, error_count;
reg [903:0] test_vectors [127:0];
reg [31:0] i_eax;
reg [31:0] i_ebx;
reg [31:0] i_ecx;
reg [31:0] i_edx;
...
always @(posedge clk)
  begin
    #1; { i_eax, i_ebx, i_ecx, i_edx, i_esi, i_edi, i_esp, i_ebp, w_eax, w_ebx, w_ecx, w_edx, w_esi, w_edi, w_esp, w_ebp, gpr_wrmask, next_eip, next_eflags, exp_o_eax, exp_o_ebx, exp_o_ecx, exp_o_edx, exp_o_esi, exp_o_edi, exp_o_esp, exp_o_ebp, exp_o_eip, exp_o_eflags } = test_vectors[current_vec];
  end
always @(negedge clk)
  begin
    if (~reset) begin
...
if (exp_o_eflags === o_eflags || exp_o_eflags === 32'bx) begin
  ...
  error_count = error_count + 1;
      ...
      if (test_vectors[current_vec] === 904'bx) begin
