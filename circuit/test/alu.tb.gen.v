...
always @(negedge clk)
  ...
  $display("TBGEN-FAIL alu:%0d expected status_out to be %h, was %h", current_vec, exp_status_out, status_out);
...
if (exp_result === result || exp_result === 32'bx) begin
  ...
  $display("TBGEN-FAIL alu:%0d expected result to be %h, was %h", current_vec, exp_result, result);
  error_count = error_count + 1;
end
