// this file was generated by ./codegen/tbgen on 2021-03-17 11:05:51 -0400
...
if (exp_prefix_operand_16bit !== prefix_operand_16bit) begin
  $display("TBGEN-FAIL decode_prefix:%0d expected prefix_operand_16bit to be %h, was %h", current_vec, exp_prefix_operand_16bit, prefix_operand_16bit);
  error_count = error_count + 1;
end else begin
  $display("TBGEN-PASS decode_prefix:%0d prefix_operand_16bit", current_vec);
end

if (exp_prefix_address_16bit !== prefix_address_16bit) begin
  $display("TBGEN-FAIL decode_prefix:%0d expected prefix_address_16bit to be %h, was %h", current_vec, exp_prefix_address_16bit, prefix_address_16bit);
  error_count = error_count + 1;
end else begin
