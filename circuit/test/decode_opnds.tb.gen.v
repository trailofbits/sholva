...
always @(posedge clk)
  begin
    #1; { unescaped_instr, eax, ebx, ecx, edx, esi, edi, esp, ebp, opc, opnd_form, imm_1byte, reg_1byte, prefix_operand_16bit, prefix_address_16bit, exp_disp_1byte, exp_opnd0_r, exp_opnd1_r, exp_opnd2_r, exp_dest0_kind, exp_dest1_kind } = test_vectors[current_vec];
  end
always @(negedge clk)
  begin
    if (~reset) begin
