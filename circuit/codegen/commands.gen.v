...
// this file was generated by codegen.py on 2021-03-12 13:10:05.882943
...
`define CMD_SBB 6'd45
`define CMD_SCAS 6'd46
`define CMD_SHLD 6'd47
`define CMD_SHRD 6'd48
`define CMD_STC 6'd49
`define CMD_STD 6'd50
`define CMD_STOS 6'd51
`define CMD_SUB 6'd52
`define CMD_TEST 6'd53
`define CMD_XCHG 6'd54
`define CMD_XOR 6'd55
`define CMD_UNKNOWN 6'd56
