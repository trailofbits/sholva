...
// this file was generated by codegen.py on 2021-03-12 13:10:05.883285
...
assign opc = ((((((((((unescaped_instr[7:0]) == (8'h0)) ||
    ...
    (`CMD_IDIV) :
    ((((((unescaped_instr[7:0]) == (8'h69)) ||
    ((unescaped_instr[7:0]) == (8'h6b))) ||
    (((unescaped_instr[7:0]) == (8'hf6)) && ((unescaped_instr[12:10]) == (3'h5)))) ||
    (((unescaped_instr[7:0]) == (8'hf7)) && ((unescaped_instr[12:10]) == (3'h5)))) ||
